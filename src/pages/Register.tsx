    ...
    <AuthLayout title="Hisob yaratish" subtitle="Minglab o'quvchilarga qo'shiling">
      ...
      <div className="space-y-2 mb-5">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-border bg-background hover:bg-muted transition-all text-sm font-medium"
        >
